...
// 	private String[] columnNames = { MessageBundle.getMessage("angal.priceslist.idm"), MessageBundle.getMessage("angal.priceslist.name"), MessageBundle.getMessage("angal.common.descriptionm"), MessageBundle.getMessage("angal.priceslist.currency") }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
